...
registerContent('p1-decorators', () => ({
  ...
  keyConcepts: [
    ...
    { title: 'functools.wraps & Decorators with Arguments', description: 'functools.wraps & Decorators with Arguments complements the core foundation. Understanding this will help you write more efficient and maintainable solutions. It is a common area where beginners and experienced practitioners differentiate themselves.' },
    { title: 'Class-based Decorators & functools.singledispatch', description: 'Mastering class-based decorators & functools.singledispatch ensures your work is robust, scalable, and production-ready. Industry professionals rely on these techniques to deliver reliable systems.' },
  ],
