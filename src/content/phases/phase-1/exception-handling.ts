...
registerContent('p1-exception-handling', () => ({
  ...
  keyConcepts: [
    ...
    { title: 'Custom Exception Classes & Exception Chaining', description: 'Custom Exception Classes & Exception Chaining complements the core foundation. Understanding this will help you write more efficient and maintainable solutions. It is a common area where beginners and experienced practitioners differentiate themselves.' },
    { title: 'Context Managers & try/finally for Cleanup', description: 'Mastering context managers & try/finally for cleanup ensures your work is robust, scalable, and production-ready. Industry professionals rely on these techniques to deliver reliable systems.' },
  ],
