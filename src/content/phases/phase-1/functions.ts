...
registerContent('p1-functions', () => ({
  ...
  keyConcepts: [
    ...
    { title: 'Scope Rules (LEGB) & Closures', description: 'Mastering scope rules (legb) & closures ensures your work is robust, scalable, and production-ready. Industry professionals rely on these techniques to deliver reliable systems.' },
  ],
