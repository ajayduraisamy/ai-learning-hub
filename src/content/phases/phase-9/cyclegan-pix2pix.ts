...
registerContent('p9-cyclegan-pix2pix', () => ({
  ...
  keyConcepts: [
    { title: 'Cycle Consistency Loss & Paired Translation', description: 'The foundation of CycleGAN & Pix2Pix rests on understanding cycle consistency loss & paired translation. This concept is central to how CycleGAN & Pix2Pix works in practice. Spend time building intuition through both study and hands-on experimentation.' },
    { title: 'PatchGAN Discriminator & Perceptual Loss', description: 'PatchGAN Discriminator & Perceptual Loss complements the core foundation. Understanding this will help you write more efficient and maintainable solutions. It is a common area where beginners and experienced practitioners differentiate themselves.' },
    { title: 'Identity Loss & Adversarial Loss Balancing', description: 'Mastering identity loss & adversarial loss balancing ensures your work is robust, scalable, and production-ready. Industry professionals rely on these techniques to deliver reliable systems.' },
  ],
